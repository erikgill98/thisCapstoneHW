...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card-group">
      <div class="card">
        <img src="img/bronze.jpg" class="card-img-top" style="width:100px;height:100px;" alt="...">
        <div class="card-body">
      ...
      <div class="card">
        <img src="silver.jpg" class="card-img-top" style="width:100px;height:100px;" alt="...">
        <div class="card-body">
      ...
      <div class="card">
        <img src="gold.jpg" class="card-img-top" style="width:100px;height:100px;" alt="...">
        <div class="card-body">
